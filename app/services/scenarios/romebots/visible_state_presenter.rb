module Scenarios
  module Romebots
    class VisibleStatePresenter
      ...
      def sections
        @sections ||= Scenarios::Romebots::Configuration::DISPLAY_GROUPS.filter_map do |group_key, group_definition|
      ...
      def display_config
        Scenarios::Romebots::Configuration::DISPLAY_CONFIG
      end

      def group_definition(group_key)
        Scenarios::Romebots::Configuration::DISPLAY_GROUPS.fetch(group_key)
      end
      ...
      def inferred_definition_for(key)
        group = Scenarios::Romebots::Configuration::DISPLAY_GROUPS.find do |_group_key, definition|
